...
/*
Same example as before (08-normalization-stock-market.js),
but now using net.forecast instead of net.run. See the end of this
file.
*/
...
console.log(
  net
    .forecast(
      // Forecast based on these 2 data points
      // We're using the training data itself, but we would
      // actually use real data we would have at the time
      [trainingData[0][0], trainingData[0][1]],
      // Forecast the 3 next steps
      3
    )
    .map(scaleUp)
);
...
[
  {
    open: 140.61785416613816,
    high: 141.95580289310215,
    low: 140.23448131358177,
    close: 141.66688830572963
  },
  {
    open: 142.270037128371,
    high: 144.04549673599004,
    low: 142.14055645896494,
    close: 143.8995723856628
  },
  {
    open: 143.56615236419438,
    high: 145.04065429597495,
    low: 143.1565689754784,
    close: 144.4953885237038
  }
]
*/
